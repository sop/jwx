 ...
 * @group jwe
 */
class RSAOAEPTest extends PHPUnit_Framework_TestCase
{
	...
	public function testEncryptA128() {
		$key_algo = RSAOAEPAlgorithm::fromPublicKey(self::$_publicKey);
	...
	public function testDecryptA128(JWE $jwe) {
		$key_algo = RSAOAEPAlgorithm::fromPrivateKey(self::$_privateKey);
		$enc_algo = new A128CBCHS256Algorithm();
