 ...
 * @internal
 */
class CookbookKeyWrapPBES2AndAESHMACSHA2Test extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        $json = file_get_contents(
            COOKBOOK_DIR . '/jwe/5_3.key_wrap_using_pbes2-aes-keywrap_with-aes-cbc-hmac-sha2.json');
    ...
    public function testEncryptedKey(Header $header)
    {
        ...
        $algo = PBES2Algorithm::fromJWK(SymmetricKeyJWK::fromKey($password), $header);
    ...
    public function testCreateJWE(Header $header)
    {
        ...
        $iv = Base64::urlDecode(self::$_testData['generated']['iv']);
        $password = self::$_testData['input']['pwd'];
        $key_algo = PBES2Algorithm::fromJWK(SymmetricKeyJWK::fromKey($password), $header);
